...
async function main() {
  ...
  await fs.writeFile(path.join(dir, "go_public_key_jwk.json"), JSON.stringify(publicJwk, null, 2));
  await fs.writeFile(path.join(dir, "go_private_key_jwk.json"), JSON.stringify(privateJwk, null, 2));
